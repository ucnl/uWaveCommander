...
Запустите приложение и нажмите кнопку **🔌 СОЕДИНЕНИЕ**, и если все сделано правильно, то приложение вскоре определит модем:
...
#### 1. Перейдите во вкладку **Локальные датчики** и включите следующие кнопки: **P, mBar**, **🌡, °C**, **🡇, m** and **⚡, V**.
#### 2. Выберите **1_SEC** в выпадающем списке **Период обновления, msec**
...
#### 1. Выберите пункт **NEVER** в выпадающем списке **Период обновления, msec**
#### 2. Нажмите кнопку **🡇 ПРИМЕНИТЬ**

### 4. Работа с короткими кодовыми запросами

Перейдите во вкладку **Командные запросы** и нажмите кнопку **AUTO**. Приложение будет посылать короткие кодовые запросы. Если у вас есть второй модем [семейства uWave](https://docs.unavlab.com/documentation/RU/uWAVE/uWAVE_Family_ru.html) и он настроен соответствующии образом, включен и располагается рядом, то вы увидети примерно такую картину:

![fig4](https://github.com/user-attachments/assets/1b8abded-f6b3-42b3-b3e3-ebab29ced7bb)


### 5. Пакетный режим

Перейдите во вкладку **Пакетный режим**. 
Здесь доступно:  
...
![fig5](https://github.com/user-attachments/assets/c461c9be-505f-4044-8311-e1f1c76f6ed3)
